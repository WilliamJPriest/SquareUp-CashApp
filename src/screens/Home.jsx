...
import { faAngleLeft,faAngleRight,faMoneyBillWave,faSmile,faCheck, faArrowTurnDown } from "@fortawesome/free-solid-svg-icons";
  ...
  let foodArray= [{"categories": [
    ...
    return(
        <div className="home-container">
            <div className="bg">
            <img id="bg1" src="/bg1.jpg" alt="" />
            <img id="bg2" src="/bg4.jpg" alt="" />
            <img id="bg3" src="/bg3.jpg" alt="" />
            <FontAwesomeIcon icon={faAngleLeft}></FontAwesomeIcon>
            <FontAwesomeIcon icon={faAngleRight}></FontAwesomeIcon>
           <div className="home-head"><h1> We Serve The Tastiest of Grilled, Barbecued and Fried Delicacies</h1></div> 
            </div>
            <div className="over">
            </div> 
            <div className="features">
                ...
                <h3>Affordable</h3>
                <p>Sold at pocket friendly price</p>
                </div>
                </div>      
                 <section className="about">
                    <div className="about-info">
                        <h2>See Our Menu <FontAwesomeIcon icon={faArrowTurnDown}/></h2>
                        {foodArray[0].categories.map((item => {
                            return(
                                <div class="options">
                            <button onClick={ () => {
                            console.log(item.idCategory);
                               document.getElementById("menu-" + item.idCategory).classList.length < 2 ? document.getElementById("menu-" + item.idCategory).classList.add('showcase') : document.getElementById("menu-" + item.idCategory).classList.remove('showcase')}
                             }>{item.strCategory}</button>
                           <div class="menu-one" id={"menu-" + item.idCategory}>
                            <Card>
                    ...
                    <div id="left-unveil"></div>
                    <div id="right-unveil"></div>
                </section> 
           <Footer/>
